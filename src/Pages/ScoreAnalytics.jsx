...
const ScoreAnalytics = () => {
    ...
    return (
        <div className="score-analytics-container">
            <h2>Your Test Analytics</h2>

            <div className="score-section" style={{cursor:"pointer"}}>
                ...
                <p className="overall-score"><strong><FaTrophy /> Overall Score:</strong> {scores.overall.toFixed(2)}%</p>
            </div>
